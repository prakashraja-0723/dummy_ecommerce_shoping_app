...
function Page() {
  ...
  return (
    <main className={`w-screen  flex flex-col relative min-h-screen`}>
      <div
      ...
      <div
        className={`my-4 lg:my-8 min-h-[66.5vh] lg:min-h-[50vh] flex items-start flex-col container mx-auto relative`}
      >
